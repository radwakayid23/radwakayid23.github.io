...
document.addEventListener('DOMContentLoaded', () => {
    const fadeElements = document.querySelectorAll('.section-header, .about-content, .work-grid, .contact-content');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Reveal work items when they come into view
...
// On page load, set dark mode from localStorage or system preference
(function() {
